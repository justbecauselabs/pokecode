...
export const inputVariants = {
  default: "bg-input border border-border rounded-md px-3 py-2 min-h-input text-foreground placeholder:text-muted-foreground",
  error: "bg-input border border-destructive rounded-md px-3 py-2 min-h-input text-foreground placeholder:text-muted-foreground",
  focused: "bg-input border border-ring rounded-md px-3 py-2 min-h-input text-foreground placeholder:text-muted-foreground"
} as const;

...
export function StopReasonDisplay({ stopReason, className = '' }: StopReasonDisplayProps) {
...
function getStopReasonConfigForDetail(reason: StopReason, stopSequence?: string) {
    switch (reason) {
      case 'end_turn':
        return {
          icon: <CheckCircle className="h-4 w-4" />,
          label: 'Response Completed',
          description: 'The assistant completed its response naturally without any interruptions.',
      ...
      case 'max_tokens':
        return {
          ...
          description: 'The response was truncated because it reached the maximum allowed token limit. Consider increasing the token limit or breaking the request into smaller parts.',
      ...
      case 'tool_use':
        return {
          ...
          description: 'The assistant needs to use tools to continue. Tool results will be processed and the response will continue.',
      ...
      case 'pause_turn':
        return {
          ...
          label: 'Turn Paused',
          description: 'The conversation turn was paused and can be continued with additional input.',
      ...
      case 'refusal':
        return {
          ...
          description: 'The assistant refused to complete this request due to safety guidelines or content policies.',
          color: 'text-red-600',
      ...
      default:
        return {
          ...
          description: 'An unknown stop reason was encountered. This may indicate a system error or new feature.',
          color: 'text-gray-600',
...
export function StopReasonDetail({ stopReason, stopSequence, className = '' }: StopReasonDetailProps) {

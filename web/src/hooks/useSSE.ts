      ...
      if (eventSource) {
        ...
        eventSource.onerror = () => {
          if (retryCountRef.current < maxRetries) {
            ...
            console.log(`SSE connection failed, retrying in ${delay}ms (attempt ${retryCountRef.current + 1}/${maxRetries})`)
            ...
            setConnectionStatus(false, 'Connection failed after multiple attempts')
          }
        }
